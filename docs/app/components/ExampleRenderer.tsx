...
export const ExampleRenderer: React.FC<ExampleRendererProps> = ({
  ...
  const [selectedValue, setSelectedValue] = useState<InitValueInput | undefined>(
  ...
  return (
    ...
    >
      ...
      <div className={numberOfMonths && numberOfMonths > 1 ? 'space-y-8' : 'grid grid-cols-1 lg:grid-cols-2 gap-8'}>
        <div>
          <h3 className='text-lg font-semibold text-white mb-4'>Component</h3>
