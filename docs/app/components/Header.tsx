        ...
        <div className='flex-1 max-w-md mx-8'>
          <div className='relative'>
            ...
            <input
              ...
              className='w-full bg-bg-primary border border-border rounded-md pl-10 pr-4 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent'
            />
          </div>
        </div>
